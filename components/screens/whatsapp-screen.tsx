...
export default function WhatsAppScreen({ onNavigate }: WhatsAppScreenProps) {
  return (
    <div className="flex flex-col min-h-screen bg-[#ECE5DD]">
      {/* WhatsApp Header */}
      <div className="bg-[#075E54] px-3 py-2 flex items-center gap-3">
        ...
        <div className="flex-1">
          <p className="text-white font-medium">SparkMoney</p>
          <p className="text-white/70 text-xs">online</p>
        </div>
        <Video className="w-5 h-5 text-white" />
        <Phone className="w-5 h-5 text-white ml-4" />
        <MoreVertical className="w-5 h-5 text-white ml-4" />
      </div>
      ...
      <div className="bg-[#F0F0F0] px-2 py-2 flex items-center gap-2">
        ...
        <button className="w-12 h-12 bg-[#075E54] rounded-full flex items-center justify-center">
