      ...
      <div className="flex-1 flex flex-col">
        <div className="px-6 pt-8 pb-6 text-center">
          <div className="relative w-48 h-48 mx-auto mb-6">
            <img src="/golden-pot-overflowing-with-gold-coins-traditional.jpg" alt="Gold pot with coins" className="w-full h-full object-contain" />
          </div>
        ...
        <div className="px-6 py-6">
          <div className="flex justify-center gap-8">
            ...
            <button onClick={() => onNavigate(2)} className="flex flex-col items-center">
              <div className="w-16 h-16 rounded-2xl bg-[#0B4DA1] flex items-center justify-center mb-2 shadow-lg">
                <Banknote className="w-8 h-8 text-white" />
              </div>
              <span className="text-xs text-[#0B4DA1] font-semibold text-center">
                Loan
                <br />
                Repayment
              </span>
        ...
        <div className="px-6 py-6 mt-auto">
          <p className="text-xs text-gray-400 text-center mb-4">Third-Party Partners</p>
          <div className="flex justify-center gap-6 opacity-50">
            <div className="w-12 h-8 bg-gray-200 rounded flex items-center justify-center">
              <span className="text-[8px] text-gray-500">HDFC</span>
            </div>
            <div className="w-12 h-8 bg-gray-200 rounded flex items-center justify-center">
              <span className="text-[8px] text-gray-500">ICICI</span>
            </div>
            <div className="w-12 h-8 bg-gray-200 rounded flex items-center justify-center">
              <span className="text-[8px] text-gray-500">SBI</span>
            </div>
            <div className="w-12 h-8 bg-gray-200 rounded flex items-center justify-center">
              <span className="text-[8px] text-gray-500">Axis</span>
            </div>
          </div>
        </div>
      </div>
